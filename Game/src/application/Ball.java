...
public class Ball extends Application{
	...
	public void getBallAnimation(){
		ParallelTransition a=new ParallelTransition();
		if(numballs==1){
			for(int i=0;i<numballs;i++){
				TranslateTransition t=new TranslateTransition(Duration.seconds(3.5),ball_list1.get(i));
				t.setByY(1900);
				t.setCycleCount(1);
				a.getChildren().add(t);
			}
			...
			for(int i=0;i<numballs;i++){
				TranslateTransition t=new TranslateTransition(Duration.seconds(3.5),ball_list2.get(i));
				t.setByY(1900);
				t.setCycleCount(1);
				a.getChildren().add(t);
			}
			...
			for(int i=0;i<numballs;i++){
				TranslateTransition t=new TranslateTransition(Duration.seconds(3.5),ball_list3.get(i));
				t.setByY(1900);
				t.setCycleCount(1);
				a.getChildren().add(t);
			}
